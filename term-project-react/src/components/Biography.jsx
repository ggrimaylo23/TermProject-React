...
export default function Biography() {
    return (
        <main>
            ...
            <p>Hello! My name is Gregory. I am a student at the Metropolitan College at Boston University, pursuing a
                ...
                the interets page on my website for further information.
